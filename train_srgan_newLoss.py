...
if __name__ == '__main__':
    ...
    # MODEL_NAME_G = f'srgan_newLoss_netG_epoch_{UPSCALE_FACTOR}_175.pth'
    # MODEL_NAME_D = f'srgan_newLoss_netD_epoch_{UPSCALE_FACTOR}_175.pth'
    ...
    # train_set = TrainDatasetFromFolder('/kaggle/input/data_17500/train', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    # val_set = ValDatasetFromFolder('/kaggle/input/data_17500/val', upscale_factor=UPSCALE_FACTOR)
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        netG.eval()
        out_path = 'training_results/srgan_newLoss_SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                if image_index == 343:
                    ...
                    sr_image.save('test_image/results/' + 'srgan_newLoss_%d_%d.png' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            torch.save(netG.state_dict(), 'epochs/srgan_newLoss_netG_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
            torch.save(netD.state_dict(), 'epochs/srgan_newLoss_netD_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'srgan_newLoss_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
