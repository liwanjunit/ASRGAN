...
if __name__ == '__main__':
    ...
    # MODEL_NAME = 'edsr_epoch_4_100.pth'
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        model.eval()
        out_path = 'training_results/edsr_SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                if image_index == 343:
                    ...
                    sr_image.save('test_image/results/' + 'edsr_%d_%d.png' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            torch.save(model.state_dict(), 'epochs/edsr_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'edsr_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
