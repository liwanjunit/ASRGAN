...
if __name__ == '__main__':
    ...
    # MODEL_NAME = f'asrresnet_new_epoch_{UPSCALE_FACTOR}_{EPOCH_SUM}.pth'
    MODEL_NAME = f'asrresnet_epoch_2_200.pth'
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        model.eval()
        out_path = 'training_results/asrresnet_new_SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                if image_index == 343:
                    ...
                    sr_image.save('test_image/results/' + 'asrresnet_new_%d_%d.png' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            torch.save(model.state_dict(), 'epochs/asrresnet_new_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'asrresnet_new_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
