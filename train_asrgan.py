...
if __name__ == '__main__':
    ...
    MODEL_NAME_G = f'asrgan_netG_epoch_{UPSCALE_FACTOR}_{EPOCH_SUM}.pth'
    MODEL_NAME_D = f'asrgan_netD_epoch_{UPSCALE_FACTOR}_{EPOCH_SUM}.pth'
    # MODEL_NAME_G = f'asrgan_netG_epoch_2_200.pth'
    # MODEL_NAME_D = f'asrgan_netD_epoch_2_200.pth'
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        netG.eval()
        out_path = 'training_results/asrgan_SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        if epoch % 1 == 0 and epoch != 0:
            torch.save(netG.state_dict(), 'epochs/asrgan_netG_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
            torch.save(netD.state_dict(), 'epochs/asrgan_netD_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'asrgan_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
