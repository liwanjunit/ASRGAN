...
if __name__ == '__main__':
    ...
    # MODEL_NAME_G = f'srgan_netG_epoch_{UPSCALE_FACTOR}_175.pth'
    # MODEL_NAME_D = f'srgan_netD_epoch_{UPSCALE_FACTOR}_175.pth'
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            torch.save(netD.state_dict(), 'epochs/srgan_netD_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'srgan_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
