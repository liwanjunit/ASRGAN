...
if __name__ == '__main__':
    ...
    MODEL_NAME = 'asrresnet_epoch_4_110.pth'
    ...
    model = Generator_ASRGAN(UPSCALE_FACTOR)
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        model.eval()
        out_path = 'training_results/asrresnet_SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        with torch.no_grad():
            ...
            for val_lr, val_hr_restore, val_hr in val_bar:
                ...
                if image_index == 343:
                    ...
                    sr_image.save('test_image/results/' + 'asrresnet_%d_%d.png' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            torch.save(model.state_dict(), 'epochs/asrresnet_epoch_%d_%d.pth' % (UPSCALE_FACTOR, epoch + EPOCH_SUM))
        ...
        if epoch % 1 == 0 and epoch != 0:
            ...
            data_frame.to_csv(out_path + 'asrresnet_train_' + str(UPSCALE_FACTOR) + f'_{epoch + EPOCH_SUM}.csv', index_label='Epoch')
